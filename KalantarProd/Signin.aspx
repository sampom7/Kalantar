...
<center>
    ...
    <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Kalantar Logo.jpeg" Width="100px" Height="75px" />
  ...
  <div class="row">
    ...
    <div class="col">
     <div style="width:100%">
        ...
        &nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="txtUserName" runat="server" Height="16px" Width="110px" TextMode="Number"></asp:TextBox>
        <br />
    </div>
    <div>
